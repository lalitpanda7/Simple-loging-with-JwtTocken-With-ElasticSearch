...
public class JwtAuthServiceApp {
  ...
  public ModelMapper modelMapper() {
    ...
    /*
     * @Override public void run(String... params) throws Exception { User admin =
     * new User(); admin.setUsername("admin"); admin.setPassword("admin");
     * admin.setEmail("admin@email.com"); admin.setRoles(new
